...
-->
        ...
        <html>
            ...
            <body>
				...
				<div class="toc">
                    ...
                    <h4><a href="#representations">Representations</a></h4>
                        <ul class="links">
    ...
    <xsl:template match="wadl:representation|wadl:fault" mode="toc">
        ...
        <xsl:choose>
            <xsl:when test="preceding::wadl:representation[@element=$id]"/>
            <xsl:otherwise>               
                <li>
                    <a href="#{$id}">
            ...
            <xsl:otherwise>
                ...
                <div class="resource">
                    ...
                    <xsl:apply-templates select="." mode="param-group">
                        <xsl:with-param name="title">Modèle de paramètres</xsl:with-param>
                    </xsl:apply-templates>
                    <xsl:apply-templates select="." mode="param-group">
    ...
    <xsl:template match="wadl:request">
        ...
        <xsl:if test="wadl:representation">
            <p><em>Représentations de la requête:</em></p>
            <ul>
    ...
    <xsl:template match="wadl:response">
        ...
        <xsl:if test="wadl:representation">
            <p><em>Représentations de la réponse:</em></p>
            <ul>
                <xsl:apply-templates select="wadl:representation"/>
            </ul>
        </xsl:if>
            ...
            <xsl:otherwise>
                ...
                <xsl:if test="@element or wadl:param">
                    <div class="representation">
                        ...
                        <xsl:apply-templates select="." mode="param-group">
                            <xsl:with-param name="title">plain</xsl:with-param>
                        </xsl:apply-templates>
                        <xsl:apply-templates select="." mode="param-group">
                            <xsl:with-param name="title">Paramètres de l'entête</xsl:with-param>
                        </xsl:apply-templates>                         
